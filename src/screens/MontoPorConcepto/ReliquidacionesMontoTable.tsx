...
export const ReliquidacionesMontoTable = ({ data, liquidacion,cliente}: TablaLiquidacion) => {
    ...
    class HeaderRow extends React.Component {
        render() {
            let header =[];
            header.push(<TableCell key={'Ingf0'} className={classes.stickyTopHeader}>NOTA DÉBITO</TableCell>);
            header.push(<TableCell key={'vacIng0'} className={classes.rightRow}></TableCell>);
            header.push(<TableCell key={'Egf0'} className={classes.stickyTopHeader}>NOTA CRÉDITO</TableCell>);
